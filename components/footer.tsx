          ...
          <Card isFooterBlurred className=" shadow-none w-full h-[300px]">
            <div className="flex flex-col items-start p-4">
              ...
              <nav className="flex flex-col space-y-2 text-sm text-gray-500">
                <a href="https://example.com"  className="hover:opacity-75">1on1 Coaching</a>
                <a href="https://example.com" className="hover:opacity-75">Company Review</a>
                <a href="https://example.com"  className="hover:opacity-75">Accounts Review</a>
                <a href="https://example.com" className="hover:opacity-75">HR Consulting</a>
                <a  href="https://example.com" className="hover:opacity-75">SEO Optimisation</a>
              </nav>
            </div>
          </Card>
          ...
          <Card isFooterBlurred className="shadow-none w-full h-[300px]">
            <div className="flex flex-col items-start p-6">
              ...
              <div className="flex items-center space-x-2 mt-2">
                ...
                <a href="tel:+1234567890" className="text-gray-600">+1234567890</a>
              </div>
              <div className="flex items-center space-x-2 mt-2">
                <svg className="w-6 h-6 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.477 2 2 6.484 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12c0-5.523-4.477-10-10-10z" />
